                    ...
                    if ($specials) {
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            foreach ($specials as $special) {
                                echo '<tr>';
                                echo '<td><a href="view-gruppa.php?id='.$special->special_id.'">'.$special->name.'</a> '. '<a href="add-special.php?id='.$special->special_id.'"><i class="fa fa-pencil"></i></a></td>';
                                echo '<td>'.$special->otdel_id.'</td>';
